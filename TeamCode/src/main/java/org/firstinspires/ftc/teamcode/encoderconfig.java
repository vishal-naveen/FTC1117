...
@Autonomous(name="Encoder Config", group="Test")
...
//        telemetry.addData("Blue ", robot.colorSensor.blue());
        ...
        encoderDrive(0.4,-79,79,-79,79,6.0);
        setZero(1000);
        encoderDrive(0.4,79,-79,79,-79,6.0);
        setZero(1000);
        encoderDrive(0.4,-19.75,19.75,-19.75,19.75,6.0);
        setZero(1000);
        encoderDrive(0.4,19.75,-19.75,19.75,-19.75,6.0);
        setZero(1000);


//        encoderDrive(0.4,  50,  50 ,50,50,10.0);  // S1: Forward 47 Inches with 5 Sec timeout
//        setZero(2500);
//        encoderDrive(0.4,-10,10, -10,10,10);
//        setZero(2000);
//        encoderDrive(0.2,10,-10,10,-10,10);
//        setZero(1000);
//        encoderDrive(0.3,   -30, -30, -30,-30,7.0);
//        setZero(2500);
//        encoderDrive(0.3,-10,10,-10,10,10);
